...
-- Create a simple policy for content sections that allows everyone to read
CREATE POLICY "Anyone can read content sections" ON public.content_sections FOR SELECT USING (true);